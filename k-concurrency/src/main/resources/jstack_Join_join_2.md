...
"main" #1 prio=5 os_prio=0 cpu=140.63ms elapsed=233.13s allocated=2567K defined_classes=71 tid=0x000001bea860b800 nid=0x2964 in Object.wait()  [0x0000008b56dff000]
...
"Reference Handler" #2 daemon prio=10 os_prio=2 cpu=0.00ms elapsed=233.12s allocated=0B defined_classes=0 tid=0x000001bec7215000 nid=0x31f8 waiting on condition  [0x0000008b574ff000]
...
"Finalizer" #3 daemon prio=8 os_prio=1 cpu=0.00ms elapsed=233.12s allocated=0B defined_classes=0 tid=0x000001bec7217000 nid=0x100c in Object.wait()  [0x0000008b575fe000]
   java.lang.Thread.State: WAITING (on object monitor)
        at java.lang.Object.wait(java.base@12.0.2/Native Method)
...
"Signal Dispatcher" #4 daemon prio=9 os_prio=2 cpu=0.00ms elapsed=233.11s allocated=0B defined_classes=0 tid=0x000001bec7233800 nid=0x2034 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

   Locked ownable synchronizers:
        - None

"Attach Listener" #5 daemon prio=5 os_prio=2 cpu=15.63ms elapsed=233.11s allocated=613K defined_classes=24 tid=0x000001bec7235000 nid=0x2984 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

   Locked ownable synchronizers:
        - None

"C2 CompilerThread0" #6 daemon prio=9 os_prio=2 cpu=46.88ms elapsed=233.11s allocated=0B defined_classes=0 tid=0x000001bec7236800 nid=0x5fd0 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE
   No compile task
...
"C1 CompilerThread0" #9 daemon prio=9 os_prio=2 cpu=125.00ms elapsed=233.11s allocated=1112B defined_classes=0 tid=0x000001bec7239800 nid=0x3a20 waiting on condition  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE
   No compile task
...
"Sweeper thread" #10 daemon prio=9 os_prio=2 cpu=0.00ms elapsed=233.11s allocated=0B defined_classes=0 tid=0x000001bec7242000 nid=0x63c0 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

   Locked ownable synchronizers:
        - None

"Common-Cleaner" #11 daemon prio=8 os_prio=1 cpu=0.00ms elapsed=233.08s allocated=0B defined_classes=0 tid=0x000001bec71fb800 nid=0xc9c in Object.wait()  [0x0000008b57bff000]
...
"Monitor Ctrl-Break" #12 daemon prio=5 os_prio=0 cpu=15.63ms elapsed=233.00s allocated=90776B defined_classes=32 tid=0x000001bec7cc3000 nid=0x5244 runnable  [0x0000008b57dfe000]
   java.lang.Thread.State: RUNNABLE
...
"Service Thread" #13 daemon prio=9 os_prio=0 cpu=0.00ms elapsed=233.00s allocated=0B defined_classes=0 tid=0x000001bec7cc5000 nid=0x45b4 runnable  [0x0000000000000000]
   java.lang.Thread.State: RUNNABLE

   Locked ownable synchronizers:
        - None

"Thread-0" #14 prio=5 os_prio=0 cpu=15.63ms elapsed=232.99s allocated=636K defined_classes=44 tid=0x000001bec7ccb800 nid=0x444c runnable  [0x0000008b580fe000]
   java.lang.Thread.State: RUNNABLE
        ...
        at sun.nio.cs.StreamDecoder.implRead(java.base@12.0.2/StreamDecoder.java:326)
        at sun.nio.cs.StreamDecoder.read(java.base@12.0.2/StreamDecoder.java:178)
        - locked <0x0000000089f16f98> (a java.io.InputStreamReader)
        at java.io.InputStreamReader.read(java.base@12.0.2/InputStreamReader.java:185)
...
"VM Thread" os_prio=2 cpu=78.13ms elapsed=233.12s tid=0x000001bec7211000 nid=0x2fcc runnable

"GC Thread#0" os_prio=2 cpu=0.00ms elapsed=233.13s tid=0x000001bea864b000 nid=0x1738 runnable

"G1 Main Marker" os_prio=2 cpu=0.00ms elapsed=233.13s tid=0x000001bea8658800 nid=0x2778 runnable

"G1 Conc#0" os_prio=2 cpu=0.00ms elapsed=233.13s tid=0x000001bea865a800 nid=0x2180 runnable

"G1 Refine#0" os_prio=2 cpu=0.00ms elapsed=233.13s tid=0x000001bec7090800 nid=0x2fc8 runnable

"G1 Young RemSet Sampling" os_prio=2 cpu=31.25ms elapsed=233.13s tid=0x000001bec7091800 nid=0x615c runnable
"VM Periodic Task Thread" os_prio=2 cpu=31.25ms elapsed=233.00s tid=0x000001bec7cc7800 nid=0x368c waiting on condition  
